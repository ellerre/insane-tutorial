...
This repository containst the code example for the tutorial of the [INSANE middleware](https://github.com/MMw-Unibo/INSANE). More tutorial information on the [Tutorial Website](http://insane-tutorial.ing.unibo.it). 
